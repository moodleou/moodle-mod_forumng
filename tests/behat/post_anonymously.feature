...
Feature: Test post anonymously functionality
  ...
  Scenario: Student don't have mod/forumng:postanon capability can not see real name in 'Usage' page
    ...
    And I should see "1" in the ".forumng_usage_contrib_cont:nth-child(1) .forumng_usage_table .forumng_usage_list_tot" "css_element"
    And I should see "Teacher 1" in the ".forumng_usage_contrib_cont:nth-child(1) .forumng_usage_table .forumng_usage_list_info .fng_userlink a" "css_element"
    And I should see "1" in the ".forumng_usage_contrib_cont:nth-child(2) .forumng_usage_table .forumng_usage_list_tot" "css_element"
    And I should see "Teacher 1" in the ".forumng_usage_contrib_cont:nth-child(2) .forumng_usage_table .forumng_usage_list_info .fng_userlink a" "css_element"
    And I log out
    ...
    And I should see "Teacher 1" in the ".forumng_usage_contrib .forumng_usage_contrib_cont:nth-child(1) .forumng_usage_table tr:nth-child(1) .forumng_usage_list_info .fng_userlink a" "css_element"
    And I should see "3" in the ".forumng_usage_contrib .forumng_usage_contrib_cont:nth-child(2) .forumng_usage_table tr:nth-child(1) .forumng_usage_list_tot" "css_element"
    And I should see "Teacher 1" in the ".forumng_usage_contrib .forumng_usage_contrib_cont:nth-child(2) .forumng_usage_table tr:nth-child(1) .forumng_usage_list_info .fng_userlink a" "css_element"
    And I should see "1" in the ".forumng_usage_contrib .forumng_usage_contrib_cont:nth-child(1) .forumng_usage_table tr:nth-child(2) .forumng_usage_list_tot" "css_element"
    And I should see "Student 1" in the ".forumng_usage_contrib .forumng_usage_contrib_cont:nth-child(1) .forumng_usage_table tr:nth-child(2) .forumng_usage_list_info .fng_userlink a" "css_element"
    And I should see "1" in the ".forumng_usage_contrib .forumng_usage_contrib_cont:nth-child(2) .forumng_usage_table tr:nth-child(2) .forumng_usage_list_tot" "css_element"
    And I should see "Student 1" in the ".forumng_usage_contrib .forumng_usage_contrib_cont:nth-child(2) .forumng_usage_table tr:nth-child(2) .forumng_usage_list_info .fng_userlink a" "css_element"