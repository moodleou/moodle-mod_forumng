...
Feature: Add forumng activity and test basic tagging functionality
  ...
  Scenario: Add group tagging to forums
    ...
    And I should see "Set tags for Group 2"
    And I should see "f1" in the ".row:first-child" "css_element"
    And I should see "f2" in the ".row:first-child" "css_element"
    And I should see "f3" in the ".row:first-child" "css_element"
    ...
    Then I should see "g1" in the ".row:nth-child(2)" "css_element"
    And I should see "g2" in the ".row:nth-child(2)" "css_element"
    And I should see "g3" in the ".row:nth-child(2)" "css_element"
    And I should see "g4" in the ".row:last-child" "css_element"
    And I should see "g5" in the ".row:last-child" "css_element"
    And I should see "g6" in the ".row:last-child" "css_element"
    ...
    And I should see "f2" in the ".row:first-child" "css_element"
    And I should see "f3" in the ".row:first-child" "css_element"
    And I should see "g1" in the ".row:nth-child(2)" "css_element"
    And I should see "g2" in the ".row:nth-child(2)" "css_element"
    And I should see "g3" in the ".row:nth-child(2)" "css_element"
    And I should not see "g4" in the ".row:nth-child(2)" "css_element"
    And I should not see "g5" in the ".row:nth-child(2)" "css_element"
    And I should not see "g6" in the ".row:nth-child(2)" "css_element"
