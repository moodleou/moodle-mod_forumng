YUI.add('moodle-mod_forumng-tagselector', function (Y, NAME) {

M.mod_forumng = M.mod_forumng || {};
M.mod_forumng.tagselector = {
    /**
            ...
            inputNode.plug(Y.Plugin.AutoComplete, {
                ...
                resultFilters: ['startsWith', function(query, results) {
                    ...
                    function compareResults(a, b) {
                        if (a.raw.displayname < b.raw.displayname) {
                            return -1;
                        }
                        if (a.raw.displayname > b.raw.displayname) {
                            return 1;
                ...
                resultFormatter: function(query, results) {
                  return Y.Array.map(results, function(result) {
                      ...
                      out += ' <span class="tagselector_result_info">' +
                              M.util.get_string('numberofdiscussions', 'forumng', result.raw.count) +
                              '</span>' + '</div>';
                    return out;
                  });
                }
