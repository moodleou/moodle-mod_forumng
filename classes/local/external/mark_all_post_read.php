...
class mark_all_post_read extends external_api {
    ...
    public static function mark_all_post_read_parameters() : external_function_parameters {
        return new external_function_parameters([
                ...
                'cloneid' => new external_value(PARAM_INT, 'Clone ID', VALUE_DEFAULT, mod_forumng::CLONE_DIRECT),
     ...
     *
     * @param int $cmid course module id - On mobile cmid is not changed to base forum.
    ...
    public static function mark_all_post_read($cmid, $cloneid, $groupid, $discussionid = 0) : array {
        try {
            ...
            $forum = mod_forumng::get_from_cmid($cmid, mod_forumng::CLONE_DIRECT);
            if ($groupid == 0) {
            ...
            if (!$discussionid) {
                ...
                $discussionforum = $discussion->get_forum();
                if ($discussionforum->is_clone()) {
