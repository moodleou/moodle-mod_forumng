...
/**
 * The mod_forumng copy discussion event.
 *
 * @package    mod_forumng
...
/**
 * The mod_forumng copied discussion event class.
 *
 * @package    mod_forumng
 * @since      Moodle 2.7
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class discussion_copied extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' copied discussion $this->objectid in the forum with the
            course module id '$this->contextinstanceid' to create new discussion {$this->other['newid']}";
    }
    ...
    public static function get_name() {
        return get_string('event:discussioncopied', 'mod_forumng');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'forumng', 'copy discussion', $this->other['logurl'],
