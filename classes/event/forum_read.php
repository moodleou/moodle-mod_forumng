...
/**
 * The mod_forumng mark all read event.
 *
 * @package    mod_forumng
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class forum_read extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' manually marked as read the forum with the " .
    ...
    public static function get_name() {
        return get_string('event:forumread', 'mod_forumng');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'forumng', 'forum read', $this->other['logurl'],
