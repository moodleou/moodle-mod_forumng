...
/**
 * Search area for mod_forumng activities.
 *
 * @package mod_forumng
...
class activity extends \core_search\base_activity {
    ...
    const FILEAREA = [
        'INTRO_AREA' => 'intro',
        'INTRODUCTION_AREA' => 'introduction'
    ];
    ...
    public function get_document($record, $options = array()) {
        ...
        $introduction = file_rewrite_pluginfile_urls($record->introduction, 'pluginfile.php', $context->id,
                $this->componentname, self::FILEAREA['INTRODUCTION_AREA'], null);
        $introduction = content_to_text($introduction, $record->introductionformat);
        $doc->set('content', $intro . $introduction);
