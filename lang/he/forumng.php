...
$string['convert_process_complete'] = 'ההמרה הושלמה ב- {$a->שניות}ש\'
(תצוגת {$a->קישור}).';
...
$string['draft_cannotreply'] = '<p>אין כרגע אפשרות להוסיף תגובה לפרסום שהטיוטה מתייחסת אליו. {$} </p><p>ניתן להשתמש בלחצן X שלצד טיוטה זו בעמוד הראשי בקבוצת הדיון, כדי לראות את 
...
$string['reportingemail'] = 'שליחת דוא"ל לשם דיווח על פרסומים לא נאותים.';
...
$string['sharedviewinfoclone'] = '<strong>קבוצת־דיון זו היא שיתופית </ strong> .<a Href=\'{$a-> url} "> קבוצת־הדיון המקורית </ a> היא {$ a->shortname}.';
$string['sharedviewinfolist'] = 'זה זמין ב: {$a}.';
$string['sharedviewinfonone'] = 'זה אינו זמין באף קורס.';
$string['sharedviewinfooriginal'] = '<strong> קבוצת־דיון זו שיתופית </ strong> תחת השם <strong>{$a} <strong/> לשימוש בקורסים אחרים';
...
$string['subscribestate_partiallysubscribed'] = 'מתקבלות הודעות בקבוצת־דיון זו, מכמה דיונים, באמצעות דוא"ל ל: {$}.';
$string['subscribestate_partiallysubscribed_thisgroup'] = 'הנכם מנויים לקבלת הודעות ממספר דיונים בקבוצה זו,  באמצעות דוא"ל ל: {$}.';
...
$string['useshared'] = 'שכפול קבוצת־דיון זו';
