...
WHERE
     ...
     * @return int Group id (will be updated if GET_GROUP_AFTER_LOGIN is specified)
     */
    public function require_view(int $groupid, int $userid = 0, bool $autologinasguest = false): int {
        global $USER, $PAGE;
